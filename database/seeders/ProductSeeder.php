    ...
    public function run(): void
    {
        $products = [
            ...
            [
                ...
                'compare_price' => 69.99,
                'stock' => 150,
                'images' => ['products/classic-black.jpg', 'products/classic-side.jpg'],
                ...
                'variants' => [
                    ...
                    ['name' => 'Color', 'value' => 'Transparente', 'price_modifier' => 5.00, 'stock' => 50],
                ],
            ],
            [
                'category_id' => 1,
                ...
                'compare_price' => 74.99,
                'stock' => 100,
                'images' => ['products/aura-gold.jpg', 'products/aura-front.jpg'],
            ...
            [
                ...
                'name' => 'nuvion Urban',
                'slug' => 'nuvion-urban',
                'description' => 'Diseño wayfarer moderno con protección de luz azul. Marco resistente de acetato premium. El equilibrio perfecto entre estilo urbano y salud visual.',
                'price' => 44.99,
                'compare_price' => null,
                'stock' => 120,
                'images' => ['products/urban-tortoise.jpg'],
                'meta_title' => 'nuvion Urban — Lentes Wayfarer Anti Luz Azul',
                'meta_description' => 'Estilo wayfarer con protección de luz azul. nuvion Urban combina diseño urbano con tecnología de filtrado premium.',
                'is_active' => true,
                'is_featured' => false,
                'variants' => [
                    ['name' => 'Color', 'value' => 'Tortoise', 'price_modifier' => 0, 'stock' => 60],
                    ['name' => 'Color', 'value' => 'Negro Brillante', 'price_modifier' => 0, 'stock' => 60],
                ],
            ],
            ...
            [
                ...
                'stock' => 80,
                'images' => ['products/vision-pro-black.jpg', 'products/vision-pro-detail.jpg'],
            ...
            [
                ...
                'stock' => 60,
                'images' => ['products/flex-rx-silver.jpg'],
            ...
            [
                ...
                'compare_price' => 89.99,
                'stock' => 90,
                'images' => ['products/pro-gamer-red.jpg', 'products/pro-gamer-action.jpg'],
            ...
            [
                ...
                'compare_price' => 79.99,
                'stock' => 70,
                'images' => ['products/sport-shield-white.jpg'],
