                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-24 rounded-2xl p-6 space-y-4" style="background:#ffffff;border:1px solid #e5e7eb;box-shadow:0 4px 16px rgba(0,0,0,0.04);">
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            {{-- Free shipping achieved (solo si el envío real es 0) --}}
                        ...
                        <div class="grid grid-cols-2 gap-3 pt-2">
                            <div class="flex items-center gap-2 text-xs" style="color:#9ca3af;">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 flex-shrink-0" style="color:#378ADD;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
