                        ...
                        <div class="grid grid-cols-12 gap-4 items-center px-4 py-5 border-b border-border/40 group hover:bg-card/30 transition-colors rounded-lg">
                            ...
                            <div class="col-span-8 md:col-span-2 flex justify-start md:justify-center">
                                <div class="flex items-center border border-border rounded-lg overflow-hidden">
                                    <button @click="updateQty(item.key, item.qty - 1)"
                                            class="w-9 h-9 flex items-center justify-center text-muted hover:text-white hover:bg-card transition-all text-sm">
                                        −
                                    </button>
                            ...
                            <div class="col-span-4 md:col-span-2 flex items-center justify-end gap-3">
                                ...
                                <button @click="removeItem(item.key)"
                                        class="text-muted/40 hover:text-red-400 transition-colors opacity-0 group-hover:opacity-100 md:opacity-0 md:group-hover:opacity-100"
                    ...
                    <div class="sticky top-24 bg-card/50 border border-border rounded-2xl p-6 space-y-4">
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="text-white" x-text="shipping === 0 ? 'Gratis' : '$' + fmt(shipping)"></span>
                            </div>
                            <template x-if="shipping > 0">
                                <p class="text-xs text-muted/60">Envío gratis en compras mayores a $99</p>
                            </template>
                        </div>
