...
@section('content')
    <form method="POST" action="{{ route('admin.categories.update', $category) }}" enctype="multipart/form-data" class="max-w-3xl space-y-6">
        @csrf @method('PUT')
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <p class="mt-2 text-xs text-gray-400">JPG, PNG o WebP. Máximo 2MB. Dejar vacío para mantener la actual.</p>
